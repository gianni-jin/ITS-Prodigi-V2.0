...
public class Insegnamento {
    ...
    public void modifichiInsegnamento() {
        ...
        int aggiornamentoOp = Main.opzioneValida(9);
        System.out.println("---------------------------------------------------------------------------------------------------------------------------------------------------------");

        if (aggiornamentoOp == 1)
            aggiorniInsegnamentoId();

        else if (aggiornamentoOp == 2)
            aggiorniNome();

        else if (aggiornamentoOp == 3)
            aggiorniDescrizione();

        else if (aggiornamentoOp == 4)
            aggiorniCorsoStudenteInsegnamento();

        else if (aggiornamentoOp == 5)
            aggiorniVotoMassimo();

        else if (aggiornamentoOp == 6)
            aggiorniVotoMinimo();

        else if (aggiornamentoOp == 7)
            aggiorniSufficienza();

        else if (aggiornamentoOp == 8)
            aggiorniTrimestre();

        else if (aggiornamentoOp == 9)
            return;
     ...
     *
     * @param student Lo studente da iscrivere all'insegnamento.
     */
    public void iscriviStudenteInInsegnamento(Studente student){
     ...
     *
     * @param student Lo studente da rimuovere dall'insegnamento.
     */
    public void rimuoviStudenteDaInsegnamento(Studente student){
        studentiIscritti.remove(student);
    }
